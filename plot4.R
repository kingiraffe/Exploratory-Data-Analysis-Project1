...
plot(hpc_sub$DateTime, as.numeric(as.character(hpc_sub$Sub_metering_1)), xlab = "", ylab = "Energy sub metering", type = "l")
lines(hpc_sub$DateTime, as.numeric(as.character(hpc_sub$Sub_metering_2)), col = "red")
lines(hpc_sub$DateTime, as.numeric(as.character(hpc_sub$Sub_metering_3)), col = "blue")
